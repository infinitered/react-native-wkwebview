                       ...
                       context:(void *)context
{
  ...
  if ([keyPath isEqualToString:@"URL"]) {
    if (_onUrlChanged && _webView && _webView.URL) {
      _onUrlChanged(@{ @"url": [_webView.URL absoluteString] });
    }
  }
}
